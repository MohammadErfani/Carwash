...
@section('content')
    <div class="overflow-x-auto relative w-5/6 mx-auto mt-10">
        ...
        <tr>
            ...
            <td class="py-4 px-6">{{$appointment->service->name}}</td>
    ...
    <form action="/following" method="post">
        ...
        <button type="submit" class="hover:shadow-form mx-auto rounded-md bg-red-600 py-3 px-8 text-center text-base font-semibold text-white outline-none">Delete</button>
    </form>
@endsection
